...
import com.acme.trackzonebackend.Authentication.application.internal.outboundservices.tokens.TokenService;
...
import com.acme.trackzonebackend.Authentication.infrastructure.persistence.jpa.repositories.UserRepository;
...
public class UserCommandServiceImpl implements UserCommandService {
    ...
    public Optional<User> handle(SignUpCommand command) {
        ...
        var user = new User(command.username(), hashingService.encode(command.password()), command.email(), command.firstname(), command.lastname(), command.address(), roles);
